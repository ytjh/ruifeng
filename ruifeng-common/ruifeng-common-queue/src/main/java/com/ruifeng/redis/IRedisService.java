...
public interface IRedisService {
     ...
     * @return Integer
     */
    Integer generate(String key);
    /**
     *根据业务key自增id 预留一个long型 如有特定业务需要用到 后边几个可将int转换去掉使用long型即可
     * @param key
     * @return long
     */
     ...
     * @return
     */
    Integer generate(String key, Date expireTime);
    /**
     *
     * @param key
     * @param increment
     * @return
     */
    Integer generate(String key, int increment);
    /**
     ...
     * @return
     */
    Integer generate(String key, int increment, Date expireTime);
    /**
     ...
     * @return
     */
    String generateIdByToday(String key, Integer length);
}
